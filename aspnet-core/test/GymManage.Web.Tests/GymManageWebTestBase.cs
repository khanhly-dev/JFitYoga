...
using GymManage.Models.TokenAuth;
...
{
    public abstract class GymManageWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GymManageWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GymManageWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GymManageDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GymManageDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GymManageDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GymManageDbContext, Task<T>> func)
        {
            T result;
